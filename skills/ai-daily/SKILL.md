...
按优先级依次抓取以下来源（固定报告窗口：`日报版次日期 08:00` 到 `次日 08:00` 的 24 小时内容）：
...
> ⏱ 时间范围：{日报版次日期} 08:00 - 次日 08:00（Asia/Shanghai）
...
- 报告窗口固定为“日报版次日期 08:00 到次日 08:00（Asia/Shanghai）”；只保留窗口内且发布时间可核验的内容
