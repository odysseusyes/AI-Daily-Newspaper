...
| 参数 | 说明 | 示例 |
|-----|------|------|
| `date` | 指定日报版次日期，留空=昨天 | `2026-04-09` |
...
- 每天 **08:00 CST** 运行时，默认生成“昨天版”日报
- 例如：`2026-04-25 08:00` 生成的是 `AI日报_2026-04-24.md`
- 固定时间窗口为：`2026-04-24 08:00` 到 `2026-04-25 08:00`（Asia/Shanghai）
- 超出窗口的旧内容直接丢弃；如果窗口内可核验内容不足，任务失败，不凑数
